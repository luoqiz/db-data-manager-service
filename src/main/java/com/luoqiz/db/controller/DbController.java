...
public class DbController {
	...
	private HttpResponseBase getTableList(DatabaseInfo dbInfo) {
	...
	private HttpResponseBase getColumnByTable(DatabaseInfo dbInfo) {
		System.out.println(dbInfo.toString());
	...
	private HttpResponseBase getDataByDbInfo(DatabaseInfo dbInfo) {
		System.out.println(dbInfo.toString());
